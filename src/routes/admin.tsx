  ...
  head: () => ({
    meta: [
      { title: "Admin Control Center · EduMaster Pro" },
      {
        name: "description",
        content:
          "Manage students, exams, resources and platform analytics from the premium glassmorphism EduMaster Pro admin dashboard.",
      },
      { property: "og:title", content: "Admin Control Center · EduMaster Pro" },
      {
